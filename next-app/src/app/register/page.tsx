    ...
    <div className="min-h-screen flex items-center justify-center px-2 py-6 relative overflow-hidden"
      ...
      <div className="w-full max-w-4xl rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden bg-white/0 relative z-10">
        ...
        <div className="flex-1 flex flex-col justify-center items-center py-10 px-6 bg-gradient-to-br from-[#F4FFEE] via-[#CDBBB9] to-[#49747F] relative">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#003447] mb-3 drop-shadow">Join Spectrate!</h1>
          <p className="text-base md:text-lg text-[#441111] mb-6 text-center max-w-md">
            {mode === "User"
              ? "Sign up to book tickets for concerts, workshops, and more in seconds!"
              : "Become an organizer and create, manage, and sell tickets to your events effortlessly!"}
          </p>
          {mode === "User" ? (
            ...
            <Button className="bg-[#49747F] hover:bg-[#003447] text-white font-semibold rounded-full px-6 py-2 shadow mb-4 transition">Host an Event</Button>
          )}
        </div>
